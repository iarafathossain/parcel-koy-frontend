...
type CategoryModalType = ModalType | "create";

const CategoryTable = ({ initialQueryString }: CategoryTableProps) => {
  ...
  const categories = categoriesDataResponse?.data || [];
  const meta: PaginationMeta | undefined = categoriesDataResponse?.meta;
  ...
  return (
    <>
      ...
      >
        {activeModal === "create" && <CreateCategory onSuccess={closeModal} />}
        ...
        {activeModal === "edit" && selectedCategory && (
          <EditCategory category={selectedCategory} onSuccess={closeModal} />
        )}

        {activeModal === "delete" && selectedCategory && (
          <DeleteCategory category={selectedCategory} onSuccess={closeModal} />
        )}
      </CommonModal>
    </>
  );
