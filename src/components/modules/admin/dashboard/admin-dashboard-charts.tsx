...
const AdminDashboardCharts = ({ charts }: AdminDashboardChartsProps) => {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Network Performance Analytics</CardTitle>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue="bar" className="w-full">
          ...
          <TabsContent value="pie" className="mt-6">
            <div className="w-full flex justify-center">
              <PieChartComponent data={charts.pie.data} total={charts.pie.total} />
            </div>
          </TabsContent>
        </Tabs>
      </CardContent>
