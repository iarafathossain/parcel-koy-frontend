...
const heroArtwork = String.raw`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="565.627" height="559.846" viewBox="0 0 565.627 559.846">
  <defs>
  ...
  <g id="Group_7220" data-name="Group 7220" transform="translate(-785.836 -183.999)">
    <g id="Group_6187" data-name="Group 6187" transform="translate(786.798 183.999)">
      ...
      <g id="Path_10818" data-name="Path 10818" transform="translate(-707.733 186.785)" fill="none" stroke-miterlimit="10">
        ...
        <path d="M 968.8968505859375 236.530029296875 L 818.3504028320312 251.9966430664062 C 812.1255493164062 251.9966430664062 807.0791015625 257.0430297851562 807.0791015625 263.2679443359375 C 807.0791015625 269.49462890625 812.1255493164062 274.5411376953125 818.3504028320312 274.5411376953125 L 968.8968505859375 290.0077514648438 C 983.6654052734375 290.0077514648438 995.636474609375 278.0365600585938 995.636474609375 263.2679443359375 C 995.636474609375 248.5010986328125 983.6654052734375 236.530029296875 968.8968505859375 236.530029296875 M 968.8455810546875 235.530029296875 L 968.8968505859375 235.530029296875 C 972.641357421875 235.530029296875 976.2743530273438 236.2635498046875 979.6949462890625 237.7102355957031 C 982.998291015625 239.1073303222656 985.9647216796875 241.1072082519531 988.511962890625 243.654296875 C 991.0591430664062 246.2013549804688 993.05908203125 249.1676940917969 994.4562377929688 252.4708251953125 C 995.9029541015625 255.89111328125 996.636474609375 259.5237731933594 996.636474609375 263.2679443359375 C 996.636474609375 267.0125122070312 995.9029541015625 270.6455078125 994.4562377929688 274.0660705566406 C 993.05908203125 277.3694763183594 991.0591430664062 280.3359680175781 988.511962890625 282.8831787109375 C 985.9647827148438 285.4303894042969 982.998291015625 287.4303588867188 979.6949462890625 288.8275146484375 C 976.2744140625 290.2742004394531 972.6414184570312 291.0077514648438 968.8968505859375 291.0077514648438 L 968.8455810546875 291.0077514648438 L 968.7946166992188 291.0025024414062 L 818.298095703125 275.541015625 C 815.0397338867188 275.5275268554688 811.9786376953125 274.2522583007812 809.6732788085938 271.9465942382812 C 807.3555297851562 269.6285705566406 806.0791015625 266.5464477539062 806.0791015625 263.2679443359375 C 806.0791015625 259.9901733398438 807.3555297851562 256.9085998535156 809.67333984375 254.5908508300781 C 811.978759765625 252.285400390625 815.0398559570312 251.01025390625 818.298095703125 250.9967651367188 L 968.8455810546875 235.530029296875 Z" stroke="none" fill="#2a2b7c"/>
      </g>
      ...
      <section className="relative overflow-hidden border-b bg-[linear-gradient(90deg,rgba(242,247,255,1)_0%,rgba(248,252,255,1)_36%,rgba(255,247,235,1)_72%,rgba(255,251,245,1)_100%)]">
        ...
        <div className="container relative mx-auto grid gap-8 px-4 py-16 md:min-h-180 md:grid-cols-[0.88fr_1.12fr] md:items-center md:py-24 lg:px-10">
          <div className="space-y-8 md:pl-6 lg:pl-12">
            <h1 className="max-w-xl text-4xl font-black leading-[1.08] tracking-tight text-foreground sm:text-5xl lg:text-[4.2rem]">
              <span className="relative inline-block">
                We Deliver
                <span className="absolute -bottom-2 left-6 h-4 w-44 rounded-[999px] border-b-4 border-primary/90" />
                <span className="absolute -bottom-1 left-7 h-4 w-40 rounded-[999px] border-b-4 border-primary/55" />
              </span>
              <span className="block">Parcel on Time with</span>
              <span className="block">no Hassle</span>
            </h1>
            <p className="max-w-lg text-[1.05rem] leading-7 text-foreground/90">
            ...
            <div>
              <Button
                asChild
                variant={"secondary"}
                className="h-14 rounded-md px-6 text-base font-semibold shadow-none transition-colors"
              >
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-sm border border-white/80 bg-white/75 shadow-sm backdrop-blur">
                  <span className="text-[#00b795]">
                    ...
                    >
                      ...
                      <path d="M8 18v-1.5A2.5 2.5 0 0 1 10.5 14h3A2.5 2.5 0 0 1 16 16.5V18" />
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-sm border border-white/80 bg-white/75 shadow-sm backdrop-blur">
                  <span className="text-[#00b795]">
                    ...
                    >
                      ...
                      <path d="M5 15.5h1.5l2-4h5l2 4H18" />
                      <path d="M7.5 13.5V11h3" />
                      <path d="M11 8.5V11" />
                    </svg>
                  </span>
                </div>
